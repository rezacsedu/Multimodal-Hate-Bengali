...
def get_parser():
    ...
    parser.add_argument("-m_path", "--model_path", type=str, default='/content/drive/MyDrive/Bengali-Hate-Speech-Detection/bangla-bert-base/store_model/',help="Save best model")
